...
// Customs js
import salesGlobalChart from './customs/sales-global-chart';
...
import salesAchiev from './customs/sales-achiev-chart';
import newCustomer from './customs/new-customer-chart';
import newProduct from './customs/new-product-chart';
import offeringChart from './customs/offering-chart';
import arDays from './customs/ar-days-chart';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  arDays();
  $("#form-ar").on('change', function (e) {
    e.preventDefault();
    arDays();
  });

  salesAchiev();
  $("#form-achiev").on('change', function (e) {
    e.preventDefault();
    salesAchiev();
  });

  newCustomer()
    $("#form-cust").on('change', function (e) {
    e.preventDefault();
    newCustomer();
  });

  newProduct();
  $("#form-prod").on('change', function (e) {
    e.preventDefault();
    newProduct();
  });

  offeringChart();
  $("#form-offer").on('change', function (e) {
    e.preventDefault();
    offeringChart();
  });
