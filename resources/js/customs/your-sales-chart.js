...
import { isEmpty } from 'lodash';
  ...
  let chart = null;
  const yourSalesChart = () => {
    const ctx = document.getElementById('your-sales-chart');
    if (!ctx) return;
    if (chart != null) {
        chart.destroy();
    }
    ...
    fetch(`/sales/your-sales/getdata?year=${year}`)
      .then(a => {
        return a.json();
      })
      .then(result => {
          ...
          options: {
            ...
            plugins: {
              ...
              htmlLegend: {
                ...
                containerID: 'your-sales-chart-legend',
              },
              tooltip: {
                callbacks: {
