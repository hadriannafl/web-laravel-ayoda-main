    ...
    <body class="font-inter antialiased bg-slate-100 text-slate-600">
        ...
        <main class="bg-white">
            <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                <!-- Page header -->
                <div class="mb-8">
                    <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Purchase Request Approval 1 📝</h1>
            </div>
            ...
            <form id="approvalForm" action="{{ route('purchase.approve1', ['idPR' => $dataPR->idrec]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    @if ($dataPR->approvalstat == 'Waiting Approval 1')
                    <<div class="flex justify-between flex-col md:flex-row mt-3">
                        <label class="block w-full md:w-1/4 text-sm font-medium mb-1" for="remarks1">Quotation Remarks 1 </label>
