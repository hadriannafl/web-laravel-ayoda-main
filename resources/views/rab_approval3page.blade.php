    ...
    <body class="font-inter antialiased bg-slate-100 text-slate-600">
        ...
        <main class="bg-white">
          <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
              ...
              @endif
              <form id="approvalForm" action="{{ route('rab.approve3', ['rabId' => $dataRab->idrec]) }}" method="post" enctype="multipart/form-data" id="myForm">
                      @csrf
                    ...
                    {{-- <div class="flex justify-between flex-col md:flex-row mt-3">
                        <label class="text-sm font-medium mb-1" for="approved3by">Approved 3 By<span class="text-rose-500">*</span>
                        </label>
                        <input id="approved3by" name="approved3by" class="approved3by form-input w-full md:w-3/4 px-2 py-1 read-only:bg-slate-200" type="text" required/>
                    </div> --}}
