...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Reimburse Approval 2</title>
    ...
    <body class="font-inter antialiased bg-slate-100 text-slate-600">
        ...
        <main class="bg-white">
            <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                ...
                @endif
                <form id="approvalForm" action="{{ route('reimburse2.approve', ['idRR' => $dataRR->idrec]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        {{-- <div class="flex flex-row mb-3 mt-3">
                            <label class="block w-full md:w-1/4 text-sm font-medium mt-1" for="approved2by">Approved 2 By<span class="text-rose-500">*</span></label>
                        ...
                        @if ($dataRR->approvalstat == 'HQ 1 Approved')
