...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Reimburse Approval 1</title>
    ...
    <body class="font-inter antialiased bg-slate-100 text-slate-600">
        ...
        <main class="bg-white">
            <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                ...
                @endif
                <form id="approvalForm" action="{{ route('reimburse.approve', ['idRR' => $dataRR->idrec]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="flex flex-row mb-3 mt-3">
                            <label class="block w-full md:w-1/4 text-sm font-medium mt-1" for="payee_bank">Company (Charged to) / Department / Currency</label>
                                ...
                                <div style="width: 20.8rem; margin-right: 20px;">
                                    <input id="deptskuy" class="form-input w-full px-2 py-1 read-only:bg-slate-200" type="text" value="{{$dataRR->department}}" readonly>
                                </div>
                                <div>
                        ...
                        {{-- <div class="flex flex-row mb-3 mt-3">
                            <label class="block w-full md:w-1/4 text-sm font-medium mt-1" for="approved1by">Approved By<span class="text-rose-500">*</span></label>
                        ...
                        @if ($dataRR->approvalstat == 'Waiting Approval 1')
                        <div class="flex flex-row mb-3 mt-3">
                        ...
                        <div class="flex justify-between flex-col md:flex-row mt-3">
                            ...
                            <textarea id="remarks1" name="remarks1" class="remarks1 form-input w-full md:w-3/4 px-2 py-1 read-only:bg-slate-200" type="text" rows="3"></textarea>
                        </div>
                            <center>
                                <tr>
                                    <input type="submit" value="Direct Approval" name="status" id="status" class="w-50 text-lg bg-amber-500 hover:bg-amber-600 text-white mt-3"/>
                                </tr>
                                <tr>
                                    <input type="submit" value="Approve" name="status" id="status2" class="w-50 text-lg bg-green-500 hover:bg-green-600 text-white mt-3"/>
                                </tr>
                                <tr>
                                    <input type="submit" value="Decline" name="status" id="status3" class="w-50 text-lg bg-red-400 border-slate-200 hover:bg-red-500 text-white mt-3" />
                                </tr>
                            </center>
                        @endif
                    </form>
        ...
        <script>
            ...
            document.getElementById('approvalForm').addEventListener('submit', function(event) {
                ...
                if ((status === 'Decline') && (remarks === '' || remarks.toLowerCase() === 'null')) {
                    alert('Remarks must Fill if "Decline"');
                    event.preventDefault();
                }
