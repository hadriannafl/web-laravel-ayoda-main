<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="table-responsive">
            <table id="request-all" class="table table-striped table-bordered text-xs" style="width:100%">
                <thead>
                    <tr>
                        <th></th>
    ...
    <script>
        $(document).ready(function () {
            $('#request-all').DataTable({
                ...
                ajax: {
                    url: "{{ route('leaverequest-all.getdata') }}"
                },
                columns: [
                    {
                        data: "label",
            ...
            $('#request-all').on("click", ".btn-modal", function () {
                ...
                $.ajax({
                    type: "GET",
                    url: `/hr/leaverequest/leaverequest-all/getdetail/${id}`,
