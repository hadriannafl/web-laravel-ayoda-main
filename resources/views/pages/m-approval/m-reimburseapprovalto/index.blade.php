    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">
                    Master Reimburse Approval To - New 🗄️
                </h1>
            </div>
        </div>
        ...
        <div class="flex flex-row text-xs">
            <label class="flex flex-row text-xs">
                <div x-data="{ modalOpen: false }">
                    ...
                    <div id="feedback-modal"
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <form action="{{route('reimburseapprovalto.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!-- Modal content -->
                                <div class="px-5 py-4">
                                    <div class="text-sm">
                ...
                <a href="{{route('reimburseapproval2to')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white text-xs mb-3 ml-5">
                    Master Reimburse Approval 2 To - New
                </a> 
            </label>
            <label class="flex flex-row text-xs">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#approvalto').DataTable({
                ...
                ajax: {
                    url: "{{ route('reimburseapprovalto.getdata') }}",
                    data:function(d){
