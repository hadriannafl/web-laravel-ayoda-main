    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex flex-row text-xs">
            <label class="flex flex-row text-xs">
                <div x-data="{ modalOpen: false }">
                    ...
                    <div id="feedback-modal"
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <form action="{{route('prapproval1to.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!-- Modal content -->
                                <div class="px-5 py-4">
                                    <div class="text-sm">
                ...
                <a href="{{route('prapproval3to')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white text-xs mb-3 ml-5">
                    Master PR Approval 3 To - New
                </a>
            </label>
            <label class="flex flex-row text-xs">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#approvalto').DataTable({
                ...
                ajax: {
                    url: "{{ route('prapproval1to.getdata') }}",
                    data:function(d){
