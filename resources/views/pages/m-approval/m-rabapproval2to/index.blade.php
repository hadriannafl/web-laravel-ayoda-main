        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">
                    Master RAB Approval 2 To - New 🗄️
                </h1>
            </div>
        </div>
        ...
        <div class="flex flex-row text-xs">
            <label class="flex flex-row text-xs">
                <div x-data="{ modalOpen: false }">
                    ...
                    </svg>&nbsp; Create New Approval 2 to</button>
                    <!-- Modal backdrop -->
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <div class="px-5 py-3 border-b border-slate-200">
                                <div class="flex justify-between items-center">
                                    <div class="font-semibold text-slate-800">Create New Approval 2 to</div>
                            ...
                            <form action="{{route('rabapproval2to.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!-- Modal content -->
                                <div class="px-5 py-4">
                                    <div class="text-sm">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="username">Approval 2 To<span
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#approvalto').DataTable({
                ...
                ajax: {
                    url: "{{ route('rabapproval2to.getdata') }}",
                    data:function(d){
