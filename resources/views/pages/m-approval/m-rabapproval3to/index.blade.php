        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">
                    Master RAB Approval 3 To - New 🗄️
                </h1>
            </div>
        </div>
        ...
        <div class="flex flex-row text-xs">
            <label class="flex flex-row text-xs">
                <div x-data="{ modalOpen: false }">
                    ...
                    </svg>&nbsp; Create New Approval 3 to</button>
                    <!-- Modal backdrop -->
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <div class="px-5 py-3 border-b border-slate-200">
                                <div class="flex justify-between items-center">
                                    <div class="font-semibold text-slate-800">Create New Approval 3 to</div>
                            ...
                            <form action="{{route('rabapproval3to.create')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!-- Modal content -->
                                <div class="px-5 py-4">
                                    <div class="text-sm">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="username">Approval 3 To<span
                                                    class="text-rose-500">*</span></label>
                                            <select id="approval_to" name="approval_to" style="width: 25rem" class="approval_to form-select w-full px-2 py-1" required>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="company">Company<span
                                                    class="text-rose-500">*</span></label>
                                            <select id="company" name="company" style="width: 25rem" class="company form-select w-full px-2 py-1" required>
                ...
                <a href="{{route('rabapproval1to')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white text-xs mb-3 ml-5">
                    Master RAB Approval 1 To - New
                </a>
                <a href="{{route('rabapproval2to')}}" class="btn bg-indigo-500 hover:bg-indigo-600 text-white text-xs mb-3 ml-5">
                    Master RAB Approval 2 To - New
                </a>     
            </label>
            <label class="flex flex-row text-xs">
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#approvalto').DataTable({
                ...
                ajax: {
                    url: "{{ route('rabapproval3to.getdata') }}",
                    data:function(d){
