                ...
                <div class="mb-6 lg:mb-0">
                    ...
                    <div class="bg-white rounded border border-slate-200 p-4">
                        <div class="text-center md:text-left md:flex md:items-center md:justify-between space-y-2 md:space-y-0 md:space-x-2">
                            <div class="text-sm">Enjoy a <span class="font-medium text-slate-800">20% OFF</span> discount on your next order 🎉</div>
                            <div class="relative inline-flex text-center px-3 py-1 rounded bg-emerald-500">
                                <div class="absolute w-3 h-3 rounded-full bg-white left-0 -translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
                                <div class="absolute w-3 h-3 rounded-full bg-white right-0 translate-x-1/2 top-1/2 -translate-y-1/2" aria-hidden="true"></div>
            ...
            <div class="lg:sticky lg:top-16 bg-slate-50 lg:overflow-x-hidden lg:overflow-y-auto no-scrollbar lg:shrink-0 border-t lg:border-t-0 lg:border-l border-slate-200 lg:w-[320px] xl:w-[352px] 2xl:w-[calc(352px+80px)] lg:h-[calc(100vh-64px)]">
                <div class="py-8 px-4 lg:px-8 2xl:px-12">
                    <div class="max-w-sm mx-auto lg:max-w-none">
                        <h2 class="text-2xl text-slate-800 font-bold mb-6">Order Summary</h2>
                        <div class="space-y-6">

                            <!-- Order Details -->
                            <div>
                                <div class="text-slate-800 font-semibold mb-2">Order Details</div>
                                <!-- Cart items -->
                                <ul>
                                    <!-- Cart item -->
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 leading-tight">The Complete Front-End Development Course!</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 ml-2">$69</div>
                                    </li>
                                    <!-- Cart item -->
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        <a class="block mr-2 xl:mr-4 shrink-0" href="#0">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 leading-tight">Web Development Ultimate Course 2021</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 ml-2">$69</div>
                                    </li>
                                    ...
                                    <li class="flex items-center py-3 border-b border-slate-200">
                                        ...
                                        <div class="grow">
                                            <a href="#0">
                                                <h4 class="text-sm font-medium text-slate-800 leading-tight">Full-Stack JavaScript Course!</h4>
                                            </a>
                                        </div>
                                        <div class="text-sm font-medium text-slate-800 ml-2">$69</div>
                                    </li>
                                ...
                                <ul>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200">
                                        ...
                                        <div class="text-sm font-medium text-slate-800 ml-2">$205</div>
                                    </li>
                                    <li class="flex items-center justify-between py-3 border-b border-slate-200">
                            ...
                            <!-- Payment Details -->
                            <div>
                                <div class="text-slate-800 font-semibold mb-4">Payment Details</div>
                            ...
                            <div class="mt-6">
                                <div class="mb-4">
                                    <a href="{{ route('pay') }}" class="btn w-full bg-indigo-500 hover:bg-indigo-600 text-white">View Your Order</a>
                                </div>
