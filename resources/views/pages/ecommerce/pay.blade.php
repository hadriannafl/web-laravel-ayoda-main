            ...
            <header class="bg-white border-b border-slate-200">
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex items-center justify-between h-16 -mb-px">
                        ...
                        <a class="block rounded-full bg-slate-100 text-slate-500 hover:text-slate-600" href="{{ route('cart') }}">
            ...
            <main>
                ...
                <div class="relative pt-8">
                    ...
                    <div class="relative px-4 sm:px-6 lg:px-8 max-w-lg mx-auto">
                        <img class="rounded-t shadow-lg" src="{{ asset('images/pay-bg.jpg') }}" width="460" height="180" alt="Pay background" />
                    </div>
                </div>
