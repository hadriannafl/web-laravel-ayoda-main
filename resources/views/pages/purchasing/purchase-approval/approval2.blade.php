<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <!-- Page header -->
        <div class="mb-8">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Purchase Request Approval 2 📝</h1>
        </div>
        ...
        <form id="approvalForm" action="{{ route('purchase-approvalga2.updatestatus', ['idPR' => $dataPR->idrec]) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <a class="block text-sm font-medium truncate transition duration-150 @if(in_array(Request::segment(1), ['#0'])){{ 'hover:text-indigo-500' }}@endif"
                        ...
                        <div class="">
                            <ul class="mt-3 @if(!in_array(Request::segment(1), ['ga'])){{ 'hidden' }}@endif"
                                ...
                                <div class="flex flex-row mb-3 mt-3">
                                    <label class="block w-full md:w-1/4 text-sm font-medium mt-1" for="payee_bank">Approval Status / Approved 1 By / Approved Date</label>
                                        <div style="width: 20.8rem; margin-right: 20px;">
                                        ...
                                        <div>
                                            <input id="balance" value="{{$dataPR->approvaldate}}" style="width: 21.2rem;" class="form-input w-full px-2 py-1 read-only:bg-slate-200" type="text" readonly/>
                                        </div>
                                </div>
                                <div class="mt-3">
                    ...
                    <table class="quotation-tables table table-striped table-bordered mt-3"
                        ...
                        <tbody class="quotation-tables" id="quotation-tables">
                            ...
                            {{-- <tr>
                                ...
                                <th class="text-sm text-center"><input type="radio" id="quotation_approval2" name="quotation_approval2" value="1"></th>
                                @if ($dataPR->quotation2 != null)
                                <th class="text-sm text-center"><input type="radio" id="quotation_approval2" name="quotation_approval2" value="2"></th>
                                @else
                                <th class="text-sm text-center"></th>
                                @endif
                                @if ($dataPR->quotation3 != null)
                                <th class="text-sm text-center"><input type="radio" id="quotation_approval2" name="quotation_approval2" value="3"></th>
                                @else
                                <th class="text-sm text-center"></th>
                                @endif
                            </tr> --}}
                ...
                <div class="flex justify-between flex-col md:flex-row mt-3">
                    <label class="block w-full md:w-1/4 text-sm font-medium mb-1" for="remarks2">Quotation Remarks 2</label>
