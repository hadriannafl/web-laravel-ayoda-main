<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <form id="approvalForm" action="{{ route('purchase-approvalga.updatestatus', ['idPR' => $dataPR->idrec]) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                {{-- <div class="flex justify-between flex-col md:flex-row mt-3">
                    ...
                    <select id="approval_to" name="approval_to" class="approval_to form-select w-full md:w-3/4 px-2 py-1" required>
                        <option hidden value="">Select Approval 2 to</option>
