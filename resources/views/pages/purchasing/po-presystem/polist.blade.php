    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex flex-row text-xs">
            <label class="flex flex-row text-xs">
                <label class="flex flex-row text-xs">
                        <a href="{{ route('po-presystem.form') }}" class="btn bg-purple-500 hover:bg-purple-600 text-white text-xs mb-3">
                        <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                            <path
                                d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                        </svg>&nbsp; New PO Pre System</a> 
                </label>
                @if (Auth::user()->company_id == '0' || Auth::user()->company_id == '999' || Auth::user()->company_id == '888')
                    <p class="flex flex-row text-slate-800 mb-3 text-sm mt-2 ml-5" for="company">Company :</p>
