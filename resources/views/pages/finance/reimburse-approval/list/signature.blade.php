<x-app-layout background="bg-white">
    ...
    <div class="px-5 py-4">
        <div class="space-y-3">
            <form method="post" id="myForm" enctype="multipart/form-data" action="{{ route('reimburse-list.signatureupdate', ['idRR' => $dataRR->idrec]) }}">
                @csrf
                ...
                <center><button class="btn bg-indigo-500 hover:bg-indigo-600 text-white mt-5" type="submit" id="create_offer">
                    <span class="xs:block ml-5 mr-5">Print Reimburse Request Document</span>
                </button> </center>
                @endif
            </form>
        </div>
