    ...
    <script>
         $(document).ready(function () {
                    ...
                    success: function (response) {
                        ...
                        for (const value of response) {
                            tableRow += `<tr>
                                            ...
                                            <td class="text-center"><a <a ${value.files == 1 ? 'hidden' : ''} href="/incident-report/filefollowup/${value.follow_upId}" target="_blank" class="btn btn-sm text-sm bg-indigo-500 hover:bg-indigo-600 text-white ml-1">View File</a></td>
            ...
            $('#incident-report').on("click", ".btn-edit", function () {
                ...
                $.ajax({
                    type: "GET",
                    url: `/incident-report/single/getreport/${id_report}`,
                    success: function (response) {
                            ...
                            <form method="post" class="form_do_update" enctype="multipart/form-data" action="/incident-report/followup">
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="sales_id">Report By<span
                                                    class="text-rose-500">*</span></label>
                                            <input id="username" name="username" class="form-input w-full px-2 py-1 read-only:bg-slate-200" type="text" value="${add_by}" readonly required/>
                                        </div>
                                        <div>
