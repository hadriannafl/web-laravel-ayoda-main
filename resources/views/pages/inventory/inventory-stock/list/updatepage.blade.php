<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <!-- Page header -->
        <div class="mb-8">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Edit Inbound Inventory 📝</h1>
        </div>
        <form action="{{ route('inbound-inventory.update', ['inboundId' => $dataInbound->idrec]) }}" method="post" enctype="multipart/form-data">
                @csrf
        ...
        <div class="flex flex-row mb-3 mt-3">
            <label class="block w-full md:w-1/4 text-sm font-medium mt-1" for="payee_bank">Reff # / Courier Name / Vehicle #</label>
                ...
                <div class="flex flex-row md:flex-row mb-3 mt-3">
                    <label class="text-sm font-medium mb-1 mt-1" for="task_id">Add Inbound Inventory
                    </label>
                ...
                <div class="flex flex-row mb-3 mt-3" hidden>
                    ...
                    <center><button class="btn bg-emerald-500 hover:bg-emerald-600 text-white mt-5" type="submit" id="create_offer">
                        <span class="xs:block ml-5 mr-5">Save Inbound Update</span>
                    </button> </center>
                    @endif
            </form>
    </div>
    ...
    <script>
        ...
        $("#tableProductAddBody").append(grandTotalRow);
                ...
                function deleteDataProduct(positionTableRow, total, dataFromDatabase,  nullParam) {
                    ...
                    Swal.fire({
                        title: 'Are you sure?',
                        text: 'Want to Delete Inbound Inventory!',
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            ...
                            Swal.fire({
                                icon : 'success',
                                title: 'Deleted!',
                                text: `Inbound Inventory has been Deleted.`,
                                confirmButtonColor: '#3085d6',
