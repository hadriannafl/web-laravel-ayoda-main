<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Inbound Inventory Form 📝</h1>
        </div>

    <div class="px-5 py-4">
        <div class="space-y-3">
            <form method="post" enctype="multipart/form-data" action="{{ route('inbound-inventory.create') }}">
                @csrf
                <div class="flex justify-between flex-col md:flex-row">
                    <label class="text-sm font-medium mb-1" for="date">Date Inbound<span
                ...
                {{-- <div class="flex justify-between flex-col md:flex-row mt-3">
                    <label class="block w-full md:w-1/4 text-sm font-medium mb-1"
                        for="image">Upload File Inbound :<span
                        class="text-rose-500">*</span>
                    </label>
                ...
                <div class="flex flex-col md:flex-row mb-3 mt-3">
                    <label class="text-sm font-medium mb-1" for="task_id">Add Inbound Inventory<span
                    class="text-rose-500">*</span>
                    </label>
                    <div x-data="{ modalOpen: false }">
                        ...
                        <div id="feedback-modal"
                            ...
                            @keydown.escape.window="modalOpen = false">
                                ...
                                <div class="px-5 py-3 border-b border-slate-200">
                                    <div class="flex justify-between items-center">
                                        <div class="font-semibold text-slate-800">Add Inventory Inbound</div>
                ...
                <div class="flex flex-row mb-3 mt-3" hidden>
                    ...
                    <div class="flex flex-row justify-center">
                        <button class="btn bg-emerald-500 hover:bg-emerald-600 text-white mt-5 ml-3" type="submit" id="create_offer">
                            <span class="xs:block ml-5 mr-5">Submit Inbound Inventory</span>
                        </button>
                    </div>
            </form>
        </div>
