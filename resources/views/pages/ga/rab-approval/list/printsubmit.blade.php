        ...
        validateDates();
         $(document).ready(function () {
            $('#approval').DataTable({
                ...
                ajax: {
                    url: "{{ route('rab-list.getprintsubmit') }}",
                    data:function(d){
            ...
            $("#btn-search").on("click", function () {
                ...
                table.ajax.url('/ga/rab-approval/list/getprintsubmit?search=1&from=' + minDate + '&to=' + maxDate + '&company=' + company + '&department=' + department).load();
            });
