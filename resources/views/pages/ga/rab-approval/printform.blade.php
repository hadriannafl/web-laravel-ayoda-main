        ...
        validateDates();
         $(document).ready(function () {
            $('#approval').DataTable({
                ...
                ajax: {
                    url: "{{ route('rab-list.getprintenforced') }}",
                    data:function(d){
            ...
            $("#btn-search").on("click", function () {
                ...
                table.ajax.url('/ga/rab-approval/list/getprintenforced?search=1&from=' + minDate + '&to=' + maxDate + '&company=' + company + '&department=' + department).load();
            });
