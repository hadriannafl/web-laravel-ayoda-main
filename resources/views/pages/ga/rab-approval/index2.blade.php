        ...
        validateDates();
         $(document).ready(function () {
            $('#approval').DataTable({
                ...
                ajax: {
                    url: "{{ route('rab-approvalga2.getdata') }}",
                    data:function(d){
                        d.status = $("#status").val()
            ...
            $("#btn-search").on("click", function () {
                ...
                table.ajax.url('/ga/rab-approval2/getdata2?search=1&from=' + minDate + '&to=' + maxDate + '&company=' + company + '&department=' + department + '&status=' + status).load();
            });
