<x-app-layout>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#office-inventory').on("click", ".btn-delete",  function () {
                const idassets = $(this).data('idassets');
                $("input[name!='_token']").val("");
                Swal.fire({
                    title: 'Are you sure?',
                    text: `Want to Delete this Inventory Asset Code ${idassets}!`,
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            type: "DELETE",
                            url: `/ga/office-inventory/delete/${idassets}`,
                            success: function (response) {
                                ...
                                if (status == 1) {
                                    Swal.fire({
                                        title: 'Success!',
                                        text: `Inventory Assets has been Deleted.`,
                                        confirmButtonColor: '#3085d6',
