<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">List M. Input Fixed Asset 📝</h1>
        </div>
        <div class="flex flex-row text-xs mb-3">
            <label class="flex flex-row text-xs">
                <a href="{{ route('fixedasset') }}" class="btn bg-purple-500 hover:bg-purple-600 text-white text-xs mb-3">
