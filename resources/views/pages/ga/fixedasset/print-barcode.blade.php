                                    ...
                                    <tr>
                                        <td class="flex justify-start">
                                            <div class="table-responsive">
                                                <table class="table table-bordered mb-10" style="font-size: 10px; border-radius: 0 0 5px 5px; border-collapse: collapse; border-width: 1px; border-color: black; width: 300px;"> 
                                                    <thead>
                                                        ...
                                                        <tr class="font-bold text-black">
                                                            <th class="text-sm text-center" style="font-size: 10px; line-height: 15px;" colspan="2">{!! DNS1D::getBarcodeHTML("*" . "$dataAsset->idfa" . "*", 'C39', 1, 33) !!}</th>
                                                        </tr>
                                                        <tr class="font-bold text-black">
