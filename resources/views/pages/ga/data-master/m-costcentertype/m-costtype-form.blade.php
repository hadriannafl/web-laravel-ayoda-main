<x-app-layout background="bg-white">
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <!-- Page header -->
        <div class="mb-8">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">New Master Cost Center Type 📝</h1>
        </div>

    <div class="px-5 py-4">
        <div class="space-y-3">
            <form action="{{route('costcenter-type.create')}}" method="post">
                @csrf
                        <div class="flex justify-between flex-col md:flex-row">
                            <label class="block text-sm font-medium mb-1" for="type">Cost Center Type Name<span
