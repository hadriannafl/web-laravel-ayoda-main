<x-app-layout>
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <div class="px-5 py-3 border-b border-slate-200">
                                <div class="flex justify-between items-center">
                                    <div class="font-semibold text-slate-800">Create New Site Warehouse</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#site-warehouse').on("click", ".btn-modal", function () {
                ...
                $.ajax({
                    type: "GET",
                    url: `/data-master/m-site-warehouse/getdata/${id}`,
                    success: function (response) {
                        const csrf_token = $('meta[name="csrf-token"]').attr('content');

                        $(".modal-content").html(`
                            <form method="post" class="type_update" enctype="multipart/form-data" action="/data-master/m-site-warehouse/update/${id}">
                                ...
                                <div class="px-5 py-4">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="company1">Company</label>
                                            <select name="company1" id="company1" class="company1 form-input w-full px-2 py-1 bg-slate-100" disabled required>
                                                @foreach ($dataChildCompany as $company)
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_name1">Warehouse Name</label>
                                            <input id="w_name1" name="w_name1" type="text"
                                                class="w_name1 form-input w-full px-2 py-1" value="${name}"
                                                required/>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_address1">Address</label>
                                            <textarea id="w_address1" name="w_address1"
                                                class="w_address1 form-input w-full px-2 py-1" rows="3"
                                                required>${address}</textarea>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_city1">City<s</label>
                                            <input id="w_city1" name="w_city1" type="text"
                                                class="w_city1 form-input w-full px-2 py-1" value="${city}"
                                                required/>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_province1">Province</label>
                                            <input id="w_province1" name="w_province1" type="text"
                                                class="w_province1 form-input w-full px-2 py-1" value="${province}"
                                                required/>
                                        </div>
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_country1">Country</label>
                                                <select name="w_country1" id="w_country1" class="w_country1 form-input w-full px-2 py-1" required>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium mb-1" for="w_zipcode1">POS Code</label>
                                            <input id="w_zipcode1" name="w_zipcode1" type="text"
                                                class="w_zipcode1 form-input w-full px-2 py-1" maxlength="10" value="${zip_code}"
                                                required/>
                                        </div>
                                    </div>
                                </div>
            ...
            $('#site-warehouse').on("click", ".btn-delete",  function () {
                ...
                Swal.fire({
                    title: 'Are you sure',
                    text: "Want to Delete Data Site Warehouse?",
                    icon: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (status == 1) {
                                    Swal.fire(
                                        'Deleted!',
                                        'Data Site Warehouse has been Deleted.',
                                        message
                                    )
