                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <div class="px-5 py-3 border-b border-slate-200">
                                <div class="flex justify-between items-center">
                                    <div class="font-semibold text-slate-800">Create New Category</div>
                            ...
                            <form action="{{route('m-category.create1')}}" method="post">
                                @csrf
                                <!-- Modal content -->
                                <div class="px-5 py-4">
                                    <div class="text-sm">
    ...
    <script>
        $(document).ready(function () {
            $('#category-table').DataTable({
                ...
                "order": [[ 0, "asc" ]],
                language: {
                    search: "Search Category/Sub Category:"
                },
                ajax: {
                    url: "{{ route('m-category.getdata1') }}"
                },
                columns: [
                    {
                        data: "name_cat",
