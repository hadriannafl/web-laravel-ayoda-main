            ...
            <label class="flex flex-row text-xs">
                <div x-data="{ modalOpen: false }">
                    <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white text-xs mb-3" @click.prevent="modalOpen = true"
                        ...
                        </svg>&nbsp; Create New Reimbursement Type</button>
                    <!-- Modal backdrop -->
                        ...
                        @keydown.escape.window="modalOpen = false">
                            ...
                            <div class="px-5 py-3 border-b border-slate-200">
                                <div class="flex justify-between items-center">
                                    <div class="font-semibold text-slate-800">Create Reimbursement Type</div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#reimburse-type').on("click", ".btn-modal", function () {
                ...
                $.ajax({
                    type: "GET",
                    url: `/ga/reimburse-type/getdata/${id}`,
                    success: function (response) {
                        const csrf_token = $('meta[name="csrf-token"]').attr('content');

                        $(".modal-content").html(`
                            <form method="post" class="type_update" enctype="multipart/form-data" action="/ga/reimburse-type/update/${id}">
                            ...
                            success: function (response) {
                                ...
                                if (status == 1) {
                                    Swal.fire({
                                        icon : 'success',
                                        title: 'Deleted!',
                                        text: `Reimbursement Type has been Deleted.`,
                                        confirmButtonColor: '#3085d6',
