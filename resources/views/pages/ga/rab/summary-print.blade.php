                                    ...
                                    <tr>
                                        <td>
                                            <table width="150" border="0" cellpadding="0" cellspacing="0" align="left" class="col" style="font-family: Arial, Helvetica, sans-serif; ">
                                                <tbody>
                                                    <tr>
                                                            <td class="flex justify-end {{ strlen($dataComps->address) > 50 ? 'mr-3' : '' }}">
                                                                @if ($dataComps->logo_filename != null)
                                                                <img src="http://ayoda.integrated-os.cloud/{{$dataComps->logo_filename}}" width="100" height="50" alt="companyLogo">
                                                                @else
                                            ...
                                            <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                                                ...
                                                <tr>
                                                    <div class="text-xs font-medium mb-1" style="font-family: Arial, Helvetica, sans-serif; font-size: 20px; letter-spacing: -1px; line-height: 1; vertical-align: top; text-align: left;">
                                                        {{$dataComps->company_type}}.&nbsp; {{$dataComps->name}}
                                                    </div>
                                        ...
                                        <td>
                                            <table width="{{ strlen($dataComps->address) < 50 ? '100' : '20' }}" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                                                <tbody><tr></tr></tbody>
                                            </table>
                                        </td>
                                    </tr>
                                                    ...
                                                    <div class="table-container2">
                                                        <div class="table-row">
                                                            ...
                                                            <div class="table-cell2 text-xs2 font-bold2">
                                                                {{ date('d F Y', strtotime($dataComps->form_date)) }}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <table class="table table-bordered mb-10" style="font-family: Arial, Helvetica, sans-serif; font-size: 10px; border-radius: 0 0 5px 5px; border-collapse: collapse; border-width: 1px; border-color: black;"> 
                                                        <thead>
                                                            <tr class="font-bold text-black bg-gray-5002">
                                                                <th class="text-sm text-center" style="font-size: 10px;">PERIOD</th>
                                                                <th class="text-sm text-center" style="font-size: 10px;">RAB #</th>
                                                                <th class="text-sm text-center" style="font-size: 10px;">RAB TYPE</th>
                                                                <th class="text-sm text-center" style="font-size: 10px; width: 200px;">RAB TITLE</th>
                                                                <th class="text-sm text-center" style="font-size: 10px; width: 50px;">DEPARTMENT</th>
                                                                <th class="text-sm text-center" style="font-size: 10px;">GRAND TOTAL</th>
                                                                <th class="text-sm text-center" style="font-size: 10px;">STATUS</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($dataRabItem as $item)
                                                            <tr>
                                                                <td class="text-sm text-center" style="font-size: 9px;">{{date('Y F', strtotime($item->date_rab))}}</td>
                                                                <td class="text-sm text-left" style="font-size: 9px;">{{$item->id_rab}}</td>
                                                                <td class="text-sm text-left" style="font-size: 9px;">{{$item->rab_type}}</td>
                                                                <td class="text-sm text-left" style="font-size: 9px;">{{$item->name_rab}}</td>
                                                                <td class="text-sm text-left" style="font-size: 9px;">{{$item->dept}}</td>
                                                                <td class="text-sm text-right" style="font-size: 9px;">{{number_format($item->gtotal, 0,',', '.')}}</td>
                                                                <td class="text-sm text-left" style="font-size: 9px;">{{$item->approvalstat}}</td>
                                                            </tr>
                                                            @endforeach
                                                            ...
                                                            <tr class="bg-gray-5002">
                                                                <td class="text-sm text-center font-bold" style="font-size: 12px;" colspan="5">TOTAL (IDR)</td>
                                                                <td class="text-sm text-right font-bold" style="font-size: 12px;">{{number_format($totals->totals, 0, ',', '.')}}</td>
                                                                <td></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                        ...
                                                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="table table-bordered" style="border-collapse: collapse; border-width: 1px; border-color: black;">
                                                            <tbody>
                                                                ...
                                                                <tr class="mb-5 font-bold">
                                                                    ...
                                                                    <td class="text-center" style="font-size: 10px; font-family: Arial, Helvetica, sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                                                                        {{date('d-M-y', strtotime($dataRab->prepared_date))}}
                                                                    </td>
                                                                    <td class="text-center" style="font-size: 10px; font-family: Arial, Helvetica, sans-serif; line-height: 18px; vertical-align: top; text-align: left;">
                                                                        Date:
                                                                    </td>
