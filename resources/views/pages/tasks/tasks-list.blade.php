        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <div class="mb-4 sm:mb-0">
                    <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">{{ $CRM_ISS->nilai }}. Tasks ✨</h1>
                </div>
                ...
                <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                    ...
                    <div class="flex shrink-0 -space-x-3 -ml-px">
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="{{ asset('images/user-32-08.jpg') }}"" width="32" height="32" alt="User 08" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="{{ asset('images/user-32-07.jpg') }}"" width="32" height="32" alt="User 07" />
                        </a>
                        <a class="block" href="#0">
                            <img class="rounded-full border-2 border-slate-100 box-content" src="{{ asset('images/user-32-05.jpg') }}"" width="32" height="32" alt="User 05" />
                        </a>
                        ...
                        <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            ...
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">Senior Software Engineer Backend</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <div class="flex shrink-0 -space-x-3 -ml-px">
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="{{ asset('images/user-32-07.jpg') }}"" width="24" height="24" alt="User 07" />
                                        </a>
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="{{ asset('images/user-32-05.jpg') }}"" width="24" height="24" alt="User 05" />
                                        </a>
                                    </div>
                                    <!-- Like button -->
                            ...
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" class="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 text-indigo-500 rounded-full" />
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">User should receive a daily digest email</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
                            ...
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" class="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 text-indigo-500 rounded-full" />
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">Change license and remove products</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
                                <div class="flex items-center justify-end space-x-3">
                                    ...
                                    <div class="flex shrink-0 -space-x-3 -ml-px">
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="{{ asset('images/user-32-08.jpg') }}"" width="24" height="24" alt="User 08" />
                                        </a>
                                        <a class="block" href="#0">
                                            <img class="rounded-full border-2 border-white box-content" src="{{ asset('images/user-32-07.jpg') }}"" width="24" height="24" alt="User 07" />
                                        </a>
                            ...
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" class="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 text-indigo-500 rounded-full" />
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">Product Update - Q4 2021</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
                            ...
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" class="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 text-indigo-500 rounded-full" />
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">Design marketing assets</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
                            ...
                            <div class="sm:flex sm:justify-between sm:items-start">
                                ...
                                <div class="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                                    <div class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" class="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 text-indigo-500 rounded-full" checked />
                                            <span class="font-medium text-slate-800 peer-checked:line-through ml-2">Update the contact page</span>
                                        </label>
                                    </div>
                                </div>
                                <!-- Right side -->
