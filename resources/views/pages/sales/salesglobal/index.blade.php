<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex flex-col col-span-full sm:col-span-6 bg-white shadow-sm rounded-sm border border-slate-200 mb-5">
            <div id="sales-global-chart-legend" class="px-5 py-3">
                <ul class="flex flex-wrap"></ul>
            </div>
            <div class="grow">
                <canvas id="sales-global-chart" width="595" height="248"></canvas>
            </div>
        </div>
        <div class="table-responsive">
            <table id="salesglobal" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#form-filter").submit(function (e) {
                e.preventDefault();
                $('#salesglobal').DataTable().ajax.reload();
            });

            $('#salesglobal').on("click", ".btn-modal", function () {
                ...
                $.ajax({
                    type: "GET",
                    url: `/sales/salesglobal/getdetail/${year}/${monthNumber}`,
                    success: function (response) {
                        $(".modal-content").html(`
                            <div class="px-5">
                                ...
                                <div class="table-responsive mt-4">
                                    <table class="table table-striped table-bordered detail-sales-global"
                                        style="width:100%">
                                        <thead>
                                            <tr>
                        ...
                        $(".detail-sales-global").find('tbody').append(tableRow);
                    },
                });
            });
        });
