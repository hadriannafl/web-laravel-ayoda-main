...
class YourSalesController extends Controller
{
    public function index()
    {
        return view('pages.sales.your-sales.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        if ($userRole == '200' || $userRole == '201' || $userRole == '202' || $userRole == '203'){
            $dataSalesGlobal->where('idsalesman', $salesId);
        }
                                    ...
                                    <div class="bg-white rounded shadow-lg overflow-auto w-full max-h-full"
                                        ...
                                        <div class="px-5 py-3 border-b border-slate-200">
                                            <div class="flex justify-between items-center">
                                                <div class="font-semibold text-slate-800">Your Sales Detail</div>
    ...
    public function getDetail($year, $month)
    {
        ...
        if ($userRole == '200' || $userRole == '201' || $userRole == '202' || $userRole == '203'){
            $dataDetailSalesGlobalQuery->where('idsalesman', $salesId);
        }
