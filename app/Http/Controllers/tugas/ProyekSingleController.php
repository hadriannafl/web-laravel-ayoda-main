...
class ProyekSingleController extends Controller
{
    ...
    {
        return view('pages.tasks.proyek.proyek-single.index');
    }
    ...
    public function form()
    {
        ...
        return view('pages.tasks.proyek.proyek-single.create-task', compact('dataCurrency'));
    }

    public function pic()
    {
        return view('pages.tasks.proyek.proyek-single.new-pic');
    }
        ...
        if ($request->ajax()) {
            return DataTables::of($dataProjects)
                ...
                ->addColumn('action', function ($dataProjects) {
                    return '    <a
                                href = "/tasks/proyek/proyek-single/updatepage/' . $dataProjects->id . '" class="btn btn-sm btn-update text-sm bg-indigo-500 hover:bg-indigo-600 text-white"
    ...
    public function updatePage(Request $request, $projectId)
    {
        ...
        return view('pages.tasks.proyek.proyek-single.updatepage', compact('viewUpdate', 'dataTasksProducts', 'histories', 'dataCurrency'));
    }
    ...
    public function createPic(Request $request){
        ...
        if ($request) {
            ...
            return to_route('proyek-single.form');
        } else {
            alert()->error('Error', 'Error Occurred');
            return to_route('proyek-single.form');
        }
