...
class LeaveApprovalController extends Controller
{
    ...
    {
        return view('pages.hr.leaveapproval.index');
    }
    ...
    public function updateApprove(Request $request, $leaveId)
    {
        ...
        $updateLeave = DB::table('employee_leaves')
            ...
            ->update([
                ...
                'approval1_name' => $dataName,
                'approval1_notes' => $request->input('approve1_notes'),
                'approval1_timestamp' => date('Y-m-d H:i:s'),
            ]);

        if ($updateLeave) {
            alert()->success('Success', 'Leave Approval Has Been Approved');
            return to_route('leaveapproval');
        } else {
